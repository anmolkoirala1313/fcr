    ...
    <div class="slider-block style-one">
        ...
        <div class="slider-main">
            <div class="slider-item slider-first">
                <div class="bg-img"> <img class="w-100 h-100 animate__animated animate__fadeIn animate__delay-0-2s" src="{{ asset('assets/frontend/images/slider/slider1.png') }}" alt=""/></div>
                <div class="container">
                    <div class="text-content flex-columns-between">
                        <div class="heading2 animate__animated animate__fadeInUp animate__delay-0-2s">Simplify and Secure <br>Your Payments with <br><span class="text-blue w-350">Our Solution</span></div>
                        <div class="body2 mt-12 text-secondary animate__animated animate__fadeInUp animate__delay-0-5s">Our platform offers secure and reliable investment <br>opportunities in the rapidly growing world of cryptocurrency.</div>
                        <div class="button-block mt-40 animate__animated animate__fadeInUp animate__delay-0-8s"><a class="button-share display-inline-block hover-button-black border-none bg-blue text-white text-button pl-28 pr-28 pt-12 pb-12 bora-8" href="service-one.html">Discovery now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="slider-item slider-second">
                <div class="bg-img"> <img class="w-100 h-100" src="{{ asset('assets/frontend/images/slider/slider1-2.png') }}" alt=""/></div>
                <div class="container">
                    <div class="text-content flex-columns-between">
                        <div class="heading2">Empower Your <br>Business with <br><span class="text-blue w-100">Seamless Payments</span></div>
                        <div class="body2 mt-12 text-secondary">Our platform offers secure and reliable investment <br>opportunities in the rapidly growing world of cryptocurrency.</div>
                        <div class="button-block mt-40"><a class="button-share display-inline-block hover-button-black border-none bg-blue text-white text-button pl-28 pr-28 pt-12 pb-12 bora-8" href="service-one.html">Discovery now</a>
                        </div>
                    </div>
                </div>
            </div>
