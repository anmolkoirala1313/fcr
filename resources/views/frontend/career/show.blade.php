...
{{--                        <img class="lazy" data-src="{{ asset(imagePath($data['row']->image)) }}" alt="" style=" height: 400px; object-fit: cover">--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                                        <span>Share on:</span>--}}
{{--                                        <a href="#"><i class="fab fa-facebook" onclick='fbShare("{{route('frontend.career.show',$data['row']->slug)}}")'></i></a>--}}
{{--                                        <a href="#"><i class="fab fa-twitter" onclick='twitShare("{{route('frontend.career.show',$data['row']->slug)}}","{{ $data['row']->title }}")'></i></a>--}}
{{--                                        <a href="#"><i class="fab fa-whatsapp" onclick='whatsappShare("{{route('frontend.career.show',$data['row']->slug)}}","{{ $data['row']->title }}")'></i></a>--}}
