...
function removeActiveHome() {
  ...
  document.querySelector('.header-menu .sub-nav-child-mobile .active').classList.remove('active');
}
...
itemLinks.forEach(function (item) {
    item.addEventListener('click', function () {
        var subNav = item.querySelector('.sub-nav-mobile');
        subNav.classList.toggle('open');
    });
});

var itemChildLinks = document.querySelectorAll('#menu-mobile-block .sub-nav-item');
itemChildLinks.forEach(function (item) {
    item.addEventListener('click', function (event) {
        // Stop the event from propagating to the parent item
        event.stopPropagation();

        var subNavChild = item.querySelector('.sub-nav-child-mobile');
        subNavChild.classList.toggle('open');

        // Check and toggle the parent item as well
        var parentItem = item.closest('.nav-item-mobile');
        if (parentItem) {
            var parentSubNav = parentItem.querySelector('.sub-nav-mobile');
